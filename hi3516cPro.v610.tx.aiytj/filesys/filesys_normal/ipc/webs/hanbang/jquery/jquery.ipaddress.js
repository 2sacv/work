        ...
        $.fn.ipaddress = function(params) {
                return $(this).each(function(){
                        ...
                        if (!$this.hasClass('ip-enabled')) {
                                ...
                                var height = parseInt($this.css("height")) + 4;
                                var width = parseInt($this.css("width")) + 4;
                                ...
                                $this.after($('<div class="ip_container" id="' + id_prefix + '_div_' +'" style="display: inline' + ((/msie/.test(navigator.userAgent.toLowerCase())) ? '' : '-block') + '; height:' + height + 'px;width:' + width + 'px;text-align:center;"/>').html(octet_html));
        ...
        $.fn.enableip = function (params){
                return $(this).each(function(){
                        ...
                        if (options.enable == true)
                        {
                                ...
                                var tempid = "";
                                for (var i = 0; i <= 3; i ++){
                                        tempid = id_prefix + '_octet_' + (i + 1);
                                        $("#" + tempid)[0].disabled = "";
                                }

                                //tempid = id_prefix + "_div_";
                                //$("#" + tempid).css("background-color", "#FFFFFF");
                        }
                        else if (options.enable == false)
                        {
                                //变灰
                                var tempid = "";
                                var color = "#FFFFFF"
                                ...
                                tempid = id_prefix + "_div_";
                                $("#" + tempid).css("background-color", color);*/
                        }
                });
        };
