...
var g_platform = "hbp2p,hbgbp2p,hbptp,hbgbptp"; //网页支持平台配置HBP2P,HBGBP2P,HBPTP,HBGBPTP
...
Language_sel = function()
{
	...
	t = typeof(t) == 'undefined' ? 0 : t; //tag_lang_default
    var v = t; //tag_specified_langaguage
    Set_cookie("languages",v);
    js = '<script type="text/javascript" src="/language/'+g_lan_js_arr[parseInt(v)]+'"></script>';
    dwn(js);
}
