...
<script type="text/javascript" src="/js/vgarea.js"></script>
    ...
    <div class="left">
        <table border=0 cellPadding=0 cellSpacing=0 class="mainTable" style="width:650px;">
             <tr><td  valign="middle" height="20px" align="left"><b>
               <script>dwn(IDC_monitor_area_alarm)</script>
             </b></td></tr>
             ...
             <tr>
               <td   align="left">
                 <div class='sTime' id='area_monitor_time_protection'></div>
               </td>
             </tr>
             ...
             <tr>
              <td align="left">
                <input type='checkbox' id='area_monitor_enb'>
                <label id='area_monitor_enb_lab' for='area_monitor_enb'><script>dwn(IDC_ENABLE_AREA);</script></label>
                <label id="area_tip" style='color:red;margin-left: 25px;'></label>
              </td>
            </tr>
            <tr>
              <td align="left">
                <input type='checkbox' id='area_blink_enb'>
                <label for='area_blink_enb'><script>dwn(IDC_BLINK_ENABLE);</script></label>
              </td>
            </tr>
            <tr height='50'>
              <td align="left">
                <span><script>dwn(IDC_scene_mode);</script></span>
                <select id="select_area_scene_mode" class="sysinput2" style="width:150px;">
            ...
            <tr height='50'>
              <td align="left">
                <div style='float: left;'><span id='ms_span'><script>dwn(IDC_sensitivity_area)</script></span></div>
                <div style='float: left;margin-left:20px;width: 360px;height:4px;' id='m_slider_area_monitor'></div>
            ...
            <tr>
              <td  align="left">
                  <button  class="BtnConfig"  onclick="clickDrawArea();" ><script>dwn(IDC_draw_area_);</script></button>
                  <button  class="BtnConfig"  onclick="clickSaveArea();"><script>dwn(IDC_SAVE);</script></button>
                  <button  class="BtnConfig"  onclick="clickDelArea();"><script>dwn(IDC_DEL);</script></button>
              </td>
            </tr>
        </table>
    </div>
