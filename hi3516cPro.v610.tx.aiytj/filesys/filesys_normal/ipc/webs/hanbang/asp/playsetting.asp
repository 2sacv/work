...
<body style="background-color: #dbdbdb;color:black">
	<table style="width:100%;height:100%;font-size:10pt;background:#dbdbdb;border-collapse:collapse;border-color: gray;">
		<tr>
		...
		<tr>
			<td colspan="2" align="center">
				<button style="width:65px;height:35px;border:none;color:black;"  onclick="savePlaySetting();"><script>dwn(IDC_SAVE)</script></button>
			</td>
		</tr>
	</table>
</body>
