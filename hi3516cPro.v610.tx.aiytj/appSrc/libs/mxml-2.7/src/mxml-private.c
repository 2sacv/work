...
#if defined(HAVE_PTHREAD_H) || (defined(WIN32) && defined(MXML1_EXPORTS))
  if (NULL != global) free(global);
  global = NULL;
#endif
...
_mxml_global(void)
{
  _mxml_global_t	*global = NULL;	/* Global data */
