 ...
 **/
void 
our_MD5Init(MD5_CTX_OUR * context)
{
...
void 
ourMD5Update(MD5_CTX_OUR * context, const unsigned char *input, unsigned int inputLen)
{
...
void 
our_MD5Final(unsigned char digest[16], MD5_CTX_OUR * context)
{
