...
EXTERN void   our_MD5Init (MD5_CTX_OUR *);
EXTERN void   ourMD5Update (MD5_CTX_OUR *, const unsigned char *, unsigned int);
EXTERN void   our_MD5Pad (MD5_CTX_OUR*);
EXTERN void   our_MD5Final (unsigned char [16], MD5_CTX_OUR*);
#endif /* _SYS_MD5_H_ */
