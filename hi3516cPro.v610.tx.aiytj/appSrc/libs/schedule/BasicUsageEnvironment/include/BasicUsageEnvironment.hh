...
{
public:
    static BasicTaskScheduler* createNew(unsigned maxSchedulerGranularity = 1000000/*microseconds*/);
...
protected:
    ...
    virtual void getBackgroundHandling(int socketNum, BackgroundHandlerProc*& handlerProc, void*& clientData);
