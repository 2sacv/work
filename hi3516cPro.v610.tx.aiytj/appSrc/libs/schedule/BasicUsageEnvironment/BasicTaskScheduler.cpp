...
void BasicTaskScheduler::getBackgroundHandling(int socketNum, BackgroundHandlerProc*& handlerProc, void*& clientData)
{
    if (socketNum < 0) return;
    fHandlers->searchHandler(socketNum, handlerProc, clientData);
}
