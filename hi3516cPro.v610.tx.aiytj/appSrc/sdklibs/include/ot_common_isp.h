...
#define OT_ISP_WIDTH_MIN                OT_ISP_RES_WIDTH_MIN
#define OT_ISP_HEIGHT_MIN               OT_ISP_RES_HEIGHT_MIN
...
#define OT_ISP_SHARPEN_MOT_NUM          16  /* Not support for Hi3519DV500 */
#define OT_ISP_SHARPEN_RLYWGT_NUM       16  /* Not support for Hi3519DV500 */
#define OT_ISP_SHARPEN_STDGAIN_NUM      16  /* Not support for Hi3519DV500 */

#define OT_ISP_MAX_SNS_REGS             50
#define OT_ISP_PIPE_SENSOR_MAX_NUM      2
...
#define OT_ISP_CCM_PROT_EN_DEFAULT                0 /* not support for Hi3516CV610 */
#define OT_ISP_CCM_RECOVER_EN_DEFAULT             1 /* not support for Hi3516CV610 */
#define OT_ISP_CCM_MATRIX_SIZE                    9
#define OT_ISP_CCM_MATRIX_NUM                     7

#define OT_ISP_COLOR_SECTOR_EN_DEFAULT            0  /* not support for Hi3519DV500 */
#define OT_ISP_COLOR_SECTOR_NUM                   6  /* not support for Hi3519DV500 */
...
} ot_isp_pipe_diff_attr; /* not support for Hi3516CV610 */
...
typedef union {
    ...
    struct {
        ...
        td_u64  bit_bypass_radial_crop    : 1;   /* RW;[15], not support for Hi3516CV610 */
        td_u64  bit_bypass_sharpen        : 1;   /* RW;[16] */
        td_u64  bit_bypass_bayer_sharpen  : 1;   /* RW;[17], not support for Hi3516CV610 */
        td_u64  bit_bypass_cac            : 1;   /* RW;[18]; */
        td_u64  bit2_chn_select           : 2;   /* RW;[19:20] */
        td_u64  bit_bypass_ldci           : 1;   /* RW;[21] */
        td_u64  bit_bypass_pregamma       : 1;   /* RW;[22], not support for Hi3519DV500 and Hi3516CV610 */
        td_u64  bit_bypass_ae_stat_fe     : 1;   /* RW;[23] */
        td_u64  bit_bypass_ae_stat_be     : 1;   /* RW;[24] */
        td_u64  bit_bypass_mg_stat        : 1;   /* RW;[25], not support for Hi3516CV610 */
        td_u64  bit_bypass_af_stat_fe     : 1;   /* RW;[26], not support for Hi3516CV610 */
        td_u64  bit_bypass_af_stat_be     : 1;   /* RW;[27] */
        td_u64  bit_bypass_awb_stat       : 1;   /* RW;[28] */
        td_u64  bit_bypass_clut           : 1;   /* RW;[29], not support for Hi3516CV610 */
        td_u64  bit_bypass_rgbir          : 1;   /* RW;[30], not support for Hi3519DV500 and Hi3516CV610 */
        td_u64  bit_bypass_lblc           : 1;   /* RW;[31] not support for Hi3516CV610 */
...
typedef enum {
    ...
    OT_ISP_MERGE_BUTT
} ot_isp_wdr_merge_mode;    /* Not support for Hi3516CV608 */
...
} ot_isp_fswdr_manual_attr; /* Not support for Hi3516CV608 */
...
typedef struct {
    ...
    td_u8 md_thr_hig_gain[OT_ISP_WDR_RATIO_NUM][OT_ISP_AUTO_ISO_NUM];    /* RW;Range:[0x0,0xFF];Format:8.0,
                                                        OT_ISP_WDR_RATIO_NUM > 6 is not support for Hi3516CV610 */
} ot_isp_fswdr_auto_attr;   /* Not support for Hi3516CV608 */
...
} ot_isp_fswdr_mdt_attr;    /* Not support for Hi3516CV608 */
...
} ot_isp_wdr_combine_attr;  /* Not support for Hi3516CV608 */

typedef struct {
    td_bool fusion_blend_en; /* not support for Hi3516CV610 */
    td_u8   fusion_blend_wgt; /* RW; Range: [0, 16]  not support for Hi3516CV610 */
...
typedef struct {
    td_u8 brightness;  /* RW; Range:[0x0, 0xF]; brightness parameter of auto tone mapping curve */
    td_u8 contrast;    /* RW; Range:[0x0, 0xF]; contrast parameter of auto tone mapping curve */
    td_u8 tolerance;   /* RW; Range:[0x0, 0xF]; tolerance of auto tone mapping curve to scene or exposure changes */
} ot_isp_drc_auto_curve_attr; /* Only support for Hi3516CV610 */
...
/* DRC curve type: 0 = Asymmetry curve, 1 = User-defined curve, 2 - Auto curve */
typedef enum {
    OT_ISP_DRC_CURVE_ASYMMETRY = 0x0,
    OT_ISP_DRC_CURVE_USER,
    OT_ISP_DRC_CURVE_AUTO, /* not support Hi3519DV500 */
    OT_ISP_DRC_CURVE_BUTT
} ot_isp_drc_curve_select;

typedef struct {
    td_bool  enable;  /* RW; Range:[0x0, 0x1]; bcnr enable */
    td_u8    detail_restore_lut[OT_ISP_DRC_BCNR_NODE_NUM]; /* RW; Range:[0x0, 0xff]; bcnr enhance curve */
    td_u8    strength; /* RW; Range:[0x0, 0x8]; bcnr filter strength */
} ot_isp_drc_bcnr_attr; /* Only support for Hi3516CV610 */

typedef struct {
    td_u8 max; /* RW; Range:[0x0, 0x80]; Bright detail enhancement max strength */
    td_u8 min; /* RW; Range:[0x0, max]; Bright detail enhancement min strength */
    td_u8 threshold; /* RW; Range:[0x0, 0xFF]; Bright detail enhancement threshold */
    td_s8 slope; /* RW; Range:[-0x7, 0x7]; Bright detail enhancement adaptation slope */
} ot_isp_drc_mixing_bright_param;

typedef struct {
    td_u8 max; /* RW; Range:[0x0, 0x80]; Dark detail enhancement max strength */
    td_u8 min; /* RW; Range:[0x0, max]; Dark detail enhancement min strength */
    td_u8 threshold; /* RW; Range:[0x0, 0xFF]; Dark detail enhancement adaptation threshold */
    td_s8 slope; /* RW; Range:[-0x7, 0x7]; Dark detail enhancement adaptation slope */
} ot_isp_drc_mixing_dark_param;
...
typedef struct {
    ...
    union {
        /*
        * AUTO:OT_CHIP: Hi3516CV610;
        * not support Hi3519DV500
        */
        ot_isp_drc_mixing_bright_param local_mixing_bright_param;
        /*
        * AUTO:OT_CHIP: Hi3519DV500;
        * RW; Range:[0x0, 0x80]; not support Hi3516CV610, LUT of enhancement coefficients for positive details
        */
    ...
    union {
        ...
        * not support Hi3519DV500
        */
        ot_isp_drc_mixing_dark_param local_mixing_dark_param;
        /*
        * AUTO:OT_CHIP: Hi3519DV500;
        * RW; Range:[0x0, 0x80]; not support Hi3516CV610, LUT of enhancement coefficients for positive details
        */
    ...
    ot_isp_drc_auto_curve_attr auto_curve; /* not support Hi3519DV500 */
    ot_isp_drc_bcnr_attr bcnr_attr; /* not support Hi3519DV500 */
} ot_isp_drc_attr;
...
typedef struct {
    ...
    td_u16   knee_point_num;      /* Range:Hi3519DV500 = [1, 256] |Hi3516CV610 = [1, 128]; Format:9.0;
                                     the number of knee point */
    ot_point knee_point_coord[OT_ISP_EXPANDER_POINT_NUM_MAX]; /* RW; Range:
                                                                 Hi3519DV500: x: [0x0, 0x100], y:[0x0, 0x100000] |
                                                                 Hi3516CV610: x: [0x0, 0x80], y:[0x0, 0x20000];
...
typedef enum {
    ...
    OT_ISP_CP_ENABLE, /* Not supported for Hi3516CV610 */
    OT_ISP_CA_BUTT
} ot_isp_ca_type;
...
typedef struct {
    ...
    ot_isp_ca_lut  ca;
    ot_isp_cp_lut  cp; /* Not supported for Hi3516CV610 */
} ot_isp_ca_attr;
...
} ot_isp_clut_attr; /* Not supported for Hi3516CV610 */

/* CLUT LUT */
typedef struct {
    td_u32 lut[OT_ISP_CLUT_LUT_LENGTH];  /* RW; Range: [0, 1073741823] */
} ot_isp_clut_lut; /* Not supported for Hi3516CV610 */
...
} ot_isp_static_dp_type; /* Not supported for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16 count_max;     /* RW; Range:Hi3519DV500 = (0, 6144];
                           Format 14.0; limited Range: (0, OT_ISP_STATIC_DP_COUNT_NORMAL*blk_num],
...
} ot_isp_dp_static_calibrate; /* Not supported for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16  bright_count; /* RW; Range:Hi3519DV500 = [0, 6144];Format 14.0;
                             limited Range: [0, OT_ISP_STATIC_DP_COUNT_NORMAL*blk_num],
...
} ot_isp_dp_static_attr; /* Not supported for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16  dst_img_height; /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, img_height], Image height that
                               crop from input raw image, set to img_height if don't need to crop */
    td_u16  dst_img_width;  /* RW; Range: [0, 65535];Format 16.0;limited Range:[0, img_width], Image width that
                               crop from input raw image, set to img_width if don't need to crop */
...
typedef enum {
    OT_ISP_MD_MODE              = 0,
    OT_ISP_PURE_TNR_MODE        = 1,
    OT_ISP_3DNR_MODE            = 2,
    OT_ISP_BNR_BUTT
} ot_isp_bnr_ref_mode;    /* Not support for Hi3519DV500 */
...
} ot_isp_nr_dering_auto_attr;   /* Not supported for Hi3516CV610 */
...
} ot_isp_nr_dering_manual_attr; /* Not supported for Hi3516CV610 */

typedef struct {
    ot_isp_nr_dering_auto_attr   dering_auto;
    ot_isp_nr_dering_manual_attr dering_manual;
} ot_isp_nr_dering_attr;    /* Not supported for Hi3516CV610 */
...
typedef enum {
    OT_NR_SNR_V0,
} ot_nr_snr_mode;   /* Not support for Hi3516CV610 */
...
typedef struct {
    td_u8   md_mode[OT_ISP_AUTO_ISO_NUM];       /* RW; Range:[0, 1];Format:1.0; motion detection window size. */
    ...
    td_u8   user_define_color_thresh[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0, 64];Format:7.0; user define motion
                                        detection strength in color area. Not support for Hi3516CV610 */
...
} ot_isp_nr_tnr_auto_attr;  /* Not support for Hi3516CV610 */

typedef struct {
    td_u8   md_mode;                  /* RW; Range:[0, 1];Format:1.0; motion detection window size. */
    ...
    td_u8   user_define_color_thresh; /* RW; Range:[0, 64];Format:7.0; user define motion detection strength in
                                         color area. Not support for Hi3516CV610 */
...
} ot_isp_nr_tnr_manual_attr;    /* Not support for Hi3516CV610 */

typedef struct {
    ot_isp_nr_tnr_auto_attr   tnr_auto;
    ot_isp_nr_tnr_manual_attr tnr_manual;
} ot_isp_nr_tnr_attr;   /* Not support for Hi3516CV610 */

typedef struct {
    td_u8   md_mode[OT_ISP_AUTO_ISO_NUM];       /* RW; Range:[0, 2];Format:2.0; motion detection window size. */
    td_u8   md_size_ratio[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0, 32];Format:6.0; motion detection size blend ratio.
                                                 Not support for Hi3516CV610 */
    td_u8   md_anti_flicker_strength[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0, 64];Format:7.0;
                                                            motion detection anti flicker strength. */
    ...
    td_u8   sfr_g[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0, 128];Format:8.0; sfr rate g */
    td_u8   sfr_b[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0, 128];Format:8.0; sfr rate b */
} ot_isp_nr_md_auto_attr;   /* Not support for Hi3519DV500 */

typedef struct {
    td_u8   md_mode;                  /* RW; Range:[0, 2];Format:2.0; motion detection window size. */
    td_u8   md_size_ratio;            /* RW; Range:[0, 32];Format:6.0; motion detection size blend ratio.
                                       Not support for Hi3516CV610 */
    td_u8   md_anti_flicker_strength; /* RW; Range:[0, 64];Format:7.0; motion detection anti flicker strength. */
    td_u8   md_static_ratio;          /* RW; Range:[0, 64];Format:7.0; motion detection static area ratio */
    ...
    td_u8   sfr_g;                    /* RW; Range:[0, 128];Format:8.0; sfr rate g */
    td_u8   sfr_b;                    /* RW; Range:[0, 128];Format:8.0; sfr rate b */
} ot_isp_nr_md_manual_attr; /* Not support for Hi3519DV500 */

typedef struct {
    ot_isp_nr_md_auto_attr   md_auto;
    ot_isp_nr_md_manual_attr md_manual;
} ot_isp_nr_md_attr;    /* Not support for Hi3519DV500 */
...
} ot_isp_nr_ynet_attr; /* Not supported for Hi3516CV610 */
...
typedef struct {
    ...
    union {
        /*
        * AUTO:OT_CHIP: Hi3519DV500;
        * RW; Range:[0, 1];Format:1.0; bayernr tnr enable. Not support for Hi3516CV610
        */
        td_bool tnr_en;
        /*
        * AUTO:OT_CHIP: Hi3516CV610;
        * RW; Range:[0, 1];Format:1.0; motion detection enable. Not support for Hi3519DV500
        */
        td_bool md_en;
    };
    ...
    td_u16     mix_gain[OT_ISP_BAYERNR_LUT_LENGTH1];    /* RW;Range:[0, 128];Format:8.0; mixing rate based on luma.
                                                            Not support for Hi3516CV610 */
    ot_isp_bnr_ref_mode   ref_mode;       /* RW; Range:[0x0, 0x2]; different ref mode. Not support for Hi3519DV500 */
    td_bool              load_ref_en;       /* RW; Range:[0x0, 0x1]; load ref enable. Not support for Hi3519DV500 */
    ...
    union {
        ...
        * Not support for Hi3519DV500;
        */
        ot_isp_nr_md_attr    md_cfg;
    };
    ot_isp_nr_wdr_attr      wdr_cfg;
    ot_isp_nr_dering_attr   dering_cfg; /* Not support for Hi3516CV610 */
} ot_isp_nr_attr;
...
typedef struct {
    ...
    td_u32  table[OT_ISP_PREGAMMA_NODE_NUM]; /* RW; Range:SD3403V100 = [0, 0xFFFFF]; Format:20.0;
                                         Not support for Hi3519DV500 and Hi3516CV610;
                                         PreGamma LUT nodes value */
} ot_isp_pregamma_attr;

typedef struct {
    td_u16 shoot_inner_threshold;       /* RW; Range: [0, 511]; Format: 9.0; Start threshold of soft processing
                                           interval, Not Support for Hi3519DV500 */
    td_u16 shoot_outer_threshold;       /* RW: Range: [0, 511]; Format: 9.0; End threshold of sort processing
                                           interval, Not Support for Hi3519DV500 */
    td_u16 shoot_protect_threshold;     /* RW: Range: [0, 511]; Format: 9.0; Hard processing of input threshold,
                                           Not Support for Hi3519DV500 */
} ot_isp_sharpen_manual_shoot_threshold_attr;


typedef struct {
    td_u16 edge_rly_fine_threshold;      /* RW; Range: [0, 1023]; Format: 10.0; Low threshold of var5,
                                            Not support for Hi3519DV500 */
    td_u16 edge_rly_coarse_threshold;    /* RW; Range: [0, 1023]; Format: 10.0; Low threshold of var7x9,
                                            Not support for Hi3519DV500 */

    td_u8  edge_overshoot;    /* RW; Range: [0, 127]; Format: 7.0; edge overshoot, Not support for Hi3519DV500 */
    td_u8  edge_undershoot;   /* RW; Range: [0, 127]; Format: 7.0; edge undershoot, Not support for Hi3519DV500 */

    td_u8  edge_gain_by_rly[OT_ISP_SHARPEN_RLYWGT_NUM];                  /* RW; Range: [0, 255];
              Format: 3.5; weight calculated by dirRly, Not support for Hi3519DV500 */
    td_u8  edge_rly_by_mot[OT_ISP_SHARPEN_STDGAIN_NUM];     /* RW; Range: [0, 63];
                 Format: 2.4; stardard gain lut calculated by motion, Not support for Hi3519DV500 */
    td_u8  edge_rly_by_luma[OT_ISP_SHARPEN_STDGAIN_NUM];       /* RW; Range: [0, 63];
                 Format: 2.4; stardard gain lut calculated by luma, Not support for Hi3519DV500 */
} ot_isp_sharpen_manual_edge_rly_attr;

typedef struct {
    td_u8  mf_gain_by_mot[OT_ISP_SHARPEN_MOT_NUM];                  /* RW; Range: [0, 32];
                 Format: 1.5; mf decline weight by motion, Not support for Hi3519DV500 */
    td_u8  hf_gain_by_mot[OT_ISP_SHARPEN_MOT_NUM];                  /* RW; Range: [0, 32];
             Format: 1.5; hf decline weight by motion, Not support for Hi3519DV500 */
    td_u8  lmf_gain_by_mot[OT_ISP_SHARPEN_MOT_NUM];                /* RW; Range: [0, 255];
                 Format: 4.4; lmf gain by mot, Not support for Hi3519DV500 */
} ot_isp_sharpen_manual_gain_by_mot_attr;
...
typedef struct {
    ...
    td_u8  over_shoot;         /* RW; Range: [0, 127]; Format:7.0; */
    td_u8  under_shoot;        /* RW; Range: [0, 127]; Format:7.0; */
    ...
    td_u16 motion_edge_strength[OT_ISP_SHARPEN_GAIN_NUM]; /* RW; Range: [0, 4095]; Format:7.5.
                                                             Not support for Hi3519DV500, Hi3516CV610 */
    td_u16 motion_texture_freq; /* RW; Range: [0, 4095]; Format:6.6. Not support for Hi3519DV500, Hi3516CV610 */
    td_u16 motion_edge_freq;   /* RW; Range: [0, 4095]; Format:6.6. Not support for Hi3519DV500, Hi3516CV610 */
    td_u8  motion_over_shoot;  /* RW; Range: [0, 127];  Format:7.0. Not support for Hi3519DV500, Hi3516CV610 */
    td_u8  motion_under_shoot; /* RW; Range: [0, 127];  Format:7.0. Not support for Hi3519DV500, Hi3516CV610 */

    td_u8  shoot_sup_strength; /* RW; Range: [0, 255]; Format:8.0;overshoot and undershoot suppression strength, the
                                  amplitude and width of shoot will be decrease when shoot_sup_strength increase */
    ...
    td_u8  detail_ctrl_threshold; /* RW; Range: [0, 255]; Format:8.0; The threshold of detail_ctrl, it is used to
    ...
    td_u8  r_gain;             /* RW; Range: Hi3519DV500 = [0, 31] | Hi3516CV610 = [0, 63];
                                  Format: Hi3519DV500 = 5.0 | Hi3516CV610 = 6.0; Sharpen Gain for Red Area */
    td_u8  g_gain;             /* RW; Range: [0, 255]; Format:8.0; Sharpen Gain for Green Area */
    td_u8  b_gain;             /* RW; Range: Hi3519DV500 = [0, 31] | Hi3516CV610 = [0, 63];
                                  Format: Hi3519DV500 = 5.0 | Hi3516CV610 = 6.0; Sharpen Gain for Blue Area */
    td_u8  skin_gain;          /* RW; Range: [0, 31]; Format:5.0; Sharpen Gain for Skin Area */
    td_u16 max_sharp_gain;     /* RW; Range: [0, 2047]; Format:8.3; Maximum sharpen gain */

    ot_isp_sharpen_manual_shoot_threshold_attr shoot_threshold_attr; /* RW; Not support for Hi3519DV500 */
    ot_isp_sharpen_manual_edge_rly_attr edge_rly_attr;               /* RW; Not support for Hi3519DV500 */
    ot_isp_sharpen_manual_gain_by_mot_attr gain_by_mot_attr;              /* RW; Not support for Hi3519DV500 */
} ot_isp_sharpen_manual_attr;

typedef struct {
    td_u16 shoot_inner_threshold[OT_ISP_AUTO_ISO_NUM];        /* RW; Range: [0, 511]; Format: 9.0;
                 Start threshold of soft processing  interval, Not support for Hi3519DV500 */
    td_u16 shoot_outer_threshold[OT_ISP_AUTO_ISO_NUM];    /* RW: Range: [0, 511]; Format: 9.0;
                 End threshold of sort processing interval, Not support for Hi3519DV500  */
    td_u16 shoot_protect_threshold[OT_ISP_AUTO_ISO_NUM];      /* RW: Range: [0, 511]; Format: 9.0;
                 Hard processing of input threshold, Not support for Hi3519DV500  */
} ot_isp_sharpen_auto_shoot_threshold_attr;


typedef struct {
    td_u16 edge_rly_fine_threshold[OT_ISP_AUTO_ISO_NUM];      /* RW; Range: [0, 1023]; Format: 10.0;
                 Low threshold of var5, Not support for Hi3519DV500 */
    td_u16 edge_rly_coarse_threshold[OT_ISP_AUTO_ISO_NUM];    /* RW; Range: [0, 1023]; Format: 10.0;
                 Low threshold of var7x9, Not support for Hi3519DV500 */
    ...
    td_u8  edge_gain_by_rly[OT_ISP_SHARPEN_RLYWGT_NUM][OT_ISP_AUTO_ISO_NUM];                  /* RW; Range: [0, 255];
              Format: 3.5; weight calculated by dirRly, Not support for Hi3519DV500 */
    td_u8  edge_rly_by_mot[OT_ISP_SHARPEN_STDGAIN_NUM][OT_ISP_AUTO_ISO_NUM];     /* RW; Range: [0, 63];
                 Format: 2.4; stardard gain lut calculated by motion, Not support for Hi3519DV500 */
    td_u8  edge_rly_by_luma[OT_ISP_SHARPEN_STDGAIN_NUM][OT_ISP_AUTO_ISO_NUM];       /* RW; Range: [0, 63];
                 Format: 2.4; stardard gain lut calculated by luma, Not support for Hi3519DV500 */
} ot_isp_sharpen_auto_edge_rly_attr;

typedef struct {
    td_u8  mf_gain_by_mot[OT_ISP_SHARPEN_MOT_NUM][OT_ISP_AUTO_ISO_NUM];                  /* RW; Range: [0, 32];
                 Format: 1.5; mf decline weight by motion, Not support for Hi3519DV500 */
    td_u8  hf_gain_by_mot[OT_ISP_SHARPEN_MOT_NUM][OT_ISP_AUTO_ISO_NUM];                  /* RW; Range: [0, 32];
             Format: 1.5; hf decline weight by motion, Not support for Hi3519DV500 */
    td_u8  lmf_gain_by_mot[OT_ISP_SHARPEN_MOT_NUM][OT_ISP_AUTO_ISO_NUM];                /* RW; Range: [0, 255];
                 Format: 4.4; lmf gain by mot, Not support for Hi3519DV500 */
} ot_isp_sharpen_auto_gain_by_mot_attr;
...
typedef struct {
    ...
    td_u16 motion_texture_strength[OT_ISP_SHARPEN_GAIN_NUM][OT_ISP_AUTO_ISO_NUM]; /* RW; Range: [0, 4095];
                                       Format:7.5. Not support for Hi3519DV500, Hi3516CV610 */
    ...
    td_u8  shoot_sup_strength[OT_ISP_AUTO_ISO_NUM];  /* RW; Range: [0, 255]; Format:8.0;overshoot and undershoot
                                                   ...
                                                   decrease when shoot_sup_strength increase */
    ...
    td_u8  detail_ctrl_threshold[OT_ISP_AUTO_ISO_NUM]; /* RW; Range: [0, 255]; Format:8.0; The threshold of detail_ctrl,
    ...
    td_u8  r_gain[OT_ISP_AUTO_ISO_NUM];  /* RW; Range: Hi3519DV500 = [0, 31] | Hi3516CV610 = [0, 63];
                                            Format: Hi3519DV500 = 5.0 | Hi3516CV610 = 6.0; Sharpen Gain for Red Area */
    td_u8  g_gain[OT_ISP_AUTO_ISO_NUM];  /* RW; Range: [0, 255]; Format:8.0; Sharpen Gain for Green Area */
    td_u8  b_gain[OT_ISP_AUTO_ISO_NUM];  /* RW; Range: Hi3519DV500 = [0, 31] | Hi3516CV610 = [0, 63];
                                            Format: Hi3519DV500 = 5.0 | Hi3516CV610 = 6.0; Sharpen Gain for Blue Area */
    td_u8  skin_gain[OT_ISP_AUTO_ISO_NUM];      /* RW; Range: [0, 31]; Format:5.0; Sharpen Gain for Skin Area */
    td_u16 max_sharp_gain[OT_ISP_AUTO_ISO_NUM]; /* RW; Range: [0, 2047]; Format:8.3; Maximum sharpen gain */

    ot_isp_sharpen_auto_shoot_threshold_attr  shoot_threshold_attr;  /* RW; Not support for Hi3519DV500 */
    ot_isp_sharpen_auto_edge_rly_attr         edge_rly_attr;         /* RW; Not support for Hi3519DV500 */
    ot_isp_sharpen_auto_gain_by_mot_attr      gain_by_mot_attr;           /* RW; Not support for Hi3519DV500 */
...
typedef struct {
    ...
    td_bool motion_en;  /* RW; Range:[0, 1]; Format:1.0;Enable/Disable motion sharpen module.
                           Not support for Hi3519DV500/Hi3516CV610 */
    td_u8   motion_threshold0; /* RW; Range: [0, 15]; Format:8.0. Not support for Hi3519DV500/Hi3516CV610 */
    td_u8   motion_threshold1; /* RW; Range: [0, 15]; Format:8.0. Not support for Hi3519DV500/Hi3516CV610 */
    td_u16  motion_gain0;      /* RW; Range: [0, 256]; Format:16.0. Not support for Hi3519DV500/Hi3516CV610 */
    td_u16  motion_gain1;      /* RW; Range: [0, 256]; Format:16.0. Not support for Hi3519DV500/Hi3516CV610 */
    ...
    ot_op_mode op_type;
    ot_isp_sharpen_detail_map  detail_map; /* RW; Not support for Hi3516CV610 */
...
typedef struct {
    ...
    union {
        /*
        * AUTO:OT_CHIP: Hi3519DV500;
        * RW; Range:[0x0, 0x10]; Format:2.2; Non-direction high frequent detail enhance strength
        * Not support for Hi3516CV610
        */
        td_u8 nddm_hf_detail_strength;
        /*
        * AUTO:OT_CHIP: Hi3516CV610;
        * RW; Range:[0x0, 0x10]; Format:5.0; high frequent detail enhance strength
        * Not support for Hi3519DV500
        */
        td_u8 hf_detail_strength;
    };
    td_u8   detail_smooth_range;     /* RW; Range:[0x1, 0x7];
    ...
    td_u8   color_noise_f_strength;  /* RW;Range:[0x0, 0x8]; Format:4.0; Strength of color noise cancel
                                        Not support for Hi3516CV610 */
    td_u8   color_noise_y_threshold; /* RW;Range:Hi3519DV500 = [0x0, 0xF];
                                        Format:8.0; Range of color denoise luma, related to luminance and saturation
                                        Not support for Hi3516CV610 */
    td_u8   color_noise_y_strength;  /* RW;Range:Hi3519DV500 = [0x0, 0x3F];
...
typedef struct {
    ...
    td_u8   nddm_mf_detail_strength[OT_ISP_AUTO_ISO_NUM]; /* RW; Range:[0x0, 0x7f];
    ...
    union {
        ...
        * Not support for Hi3519DV500
        */
        td_u8 hf_detail_strength[OT_ISP_AUTO_ISO_NUM];
    };
    td_u8   detail_smooth_range[OT_ISP_AUTO_ISO_NUM];     /* RW; Range:[0x1, 0x7];
                                                             Format:4.0; Detail smooth range */
    ...
    td_u8   color_noise_f_strength[OT_ISP_AUTO_ISO_NUM];  /* RW;Range:[0x0, 0x8]; Format:4.0; Strength of color
                                                             noise cancel
                                                             Not support for Hi3516CV610 */
    td_u8   color_noise_y_threshold[OT_ISP_AUTO_ISO_NUM];  /* RW;Range:Hi3519DV500 = [0x0, 0xF]; Format:8.0;
                                                    Range of color denoise luma, related to luminance and saturation
                                                    Not support for Hi3516CV610 */
    td_u8   color_noise_y_strength[OT_ISP_AUTO_ISO_NUM];   /* RW;Range:Hi3519DV500 = [0x0, 0x3F]; Format:8.0;Format:8.0;
...
typedef struct {
    ...
    ot_isp_black_level_dynamic_attr dynamic_attr; /* not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_u32              offset[OT_ISP_STRIPING_MAX_NUM]; /* RW;Range:[0, 0x3FFF];Format:14.0;
                                                          FPN frame offset (agv pixel value),
...
typedef struct {
    ...
    td_bool                aibnr_mode; /* RW;Range:[0,1];Format:1.0; Not Support for Hi3516CV610 */
...
typedef struct {
    td_u16  edge_threshold[OT_ISP_CAC_THR_NUM][OT_ISP_AUTO_ISO_NUM]; /* RW; range: [0, 4095]; format:12.0;
                                                                        cac edge threshold */
    td_u16  edge_gain[OT_ISP_AUTO_ISO_NUM];           /* RW; range: Hi3519DV500 = [0, 1023] | Hi3516CV610 = [0, 63];
                                                         format:10.0; cac edge gain */
    td_u16  cac_rb_strength[OT_ISP_AUTO_ISO_NUM];     /* RW; range: Hi3519DV500 = [0, 31] | Hi3516CV610 = [0, 5];
                                                         format:5.0; cac strength on rb */
    ...
    td_u16  satu_low_threshold[OT_ISP_AUTO_ISO_NUM];  /* RW; range: Hi3519DV500 = [0, 4095] | Hi3516CV610 = [0, 255];
                                                         format:12.0; cac purple saturation low threshold */
...
typedef struct {
    ...
    td_u16  edge_gain;              /* RW; range: Hi3519DV500 = [0, 1023] | Hi3516CV610 = [0, 63]; format:10.0;
                                       cac edge gain */
    td_u16  cac_rb_strength;        /* RW; range: Hi3519DV500 = [0, 31] | Hi3516CV610 = [0, 5]; format:5.0;
                                       cac strength on rb */
    td_u16  purple_alpha;           /* RW; range: [0, 63]; format:6.0; cac purple alpha */
    td_u16  edge_alpha;             /* RW; range: [0, 63]; format:6.0; cac edge alpha */
    td_u16  satu_low_threshold;     /* RW; range: Hi3519DV500 = [0, 4095] | Hi3516CV610 = [0, 255]; format:12.0;
...
typedef struct {
    ...
    td_u8   detect_mode;                /* RW; range: [0, 2]; format:2.0; cac edge detect mode
                                           Not support for Hi3516CV610 */
    td_s16  purple_upper_limit;         /* RW; range: Hi3519DV500 = [-2048,2047]; format:s12.0 |
                                           Hi3516CV610 = [-512, 511]; format:s10.0; cac purple high limitation */
    td_s16  purple_lower_limit;         /* RW; range: Hi3519DV500 = [-2048,2047]; format:s12.0 |
                                           Hi3516CV610 = [-512, 511]; format:s10.0; cac purple low limitation */
...
typedef struct {
    ...
    td_u32   radius;       /* RW;Range:[0, 11586];Format:14.0; when the distance to central pixel is greater than
                              radius, the pixel value becomes 0. */
} ot_isp_rc_attr; /* Not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16 edge_freq;            /* R; range: [0, 4095];Format:6.6; Edge frequency adjustment.
                                    Edge will be narrower and thiner when it increase */
    td_u8  over_shoot;           /* R; range: [0, 127]; Format:7.0 */
    td_u8  under_shoot;          /* R; range: [0, 127]; Format:7.0 */
    td_u8  shoot_sup_strength; /* R; range: [0, 255]; Format:8.0;overshoot and undershoot suppression strength,
                                  the amplitude and width of shoot will be decrease when shoot_sup_strength increase */
    ...
    td_u32 wdr_exp_ratio_actual[OT_ISP_WDR_MAX_FRAME_NUM - 1]; /* R; Range:[0x40, 0x4000]; Format:26.6;
                                                         ...
                                                         When exp_ratio_type is OT_OP_MODE_MANUAL, exp_ratio is
...
typedef struct {
    ...
    td_u16  x;   /* RW; Range: Hi3519DV500 = [0, 8192 - 256]; Hi3516CV610 = [0, 4096 - 120];
                    Format:13.0;AE image crop start x,
                    limited range: Hi3519DV500 = [0, ImageWidth - 256]; Hi3516CV610 = [0, ImageWidth - 120] */
    td_u16  y;   /* RW; Range: Hi3519DV500 = [0, 8192 - 120]; Hi3516CV610 = [0, 4096 - 120];
                    Format:13.0;AEimage crop start y, limited range:[0, ImageHeight - 120]  */
    td_u16  width;   /* RW; Range: Hi3519DV500 = [256, 8192]; Hi3516CV610 = [120, 4096];
                    Format:14.0;AE image crop width,
                    limited range: Hi3519DV500 = [256, ImageWidth], Hi3519DV500 = [120, ImageWidth] */
    td_u16  height;   /* RW; Range: Hi3519DV500 = [120, 8192]; Hi3516CV610 = [120, 4096];
...
typedef struct {
    ...
    td_u8 be_weight[OT_ISP_BE_AE_ZONE_ROW][OT_ISP_BE_AE_ZONE_COLUMN]; /* RW; Range:[0x0, 0xF]; Format:4.0;
     AE weighting table, Not support for Hi3519DV500 */
} ot_isp_ae_stats_cfg;
...
typedef struct {
    td_u8               gamma_gain_limit; /* RW; Range: [0x0, 0x5]; Format:3.0;
                                          Not support for Hi3519DV500, Hi3516CV610 */
    td_u8               gamma_value;      /* RW; Range: Hi3519DV500 = [0x0, 0x1] | Hi3516CV610 = [0x0, 0x1]; */
...
/*
   ...
   ... to do this job, so ctrl for MPI behavior control, and update for ISR access control,...
   ... they were independent. but they have the same bit order, for example...
   ... bit1_ae_stat1 of ctrl for MPI ae_stat1 access key, and bit1_ae_stat1 of update for ISR ae_stat1 access key
 */
typedef union {
    td_u32  key;
    struct {
        td_u32  bit1_fe_ae_global_stat         : 1;   /* [0] */
        td_u32  bit1_fe_ae_local_stat          : 1;   /* [1] not support for Hi3516CV610 */
        td_u32  bit1_fe_ae_stitch_global_stat  : 1;   /* [2] not support for Hi3516CV610 */
        td_u32  bit1_fe_ae_stitch_local_stat   : 1;   /* [3] not support for Hi3516CV610 */
        td_u32  bit1_be_ae_global_stat         : 1;   /* [4] */
        td_u32  bit1_be_ae_local_stat          : 1;   /* [5] */
        td_u32  bit1_be_ae_stitch_global_stat  : 1;   /* [6] not support for Hi3516CV610 */
        td_u32  bit1_be_ae_stitch_local_stat   : 1;   /* [7] not support for Hi3516CV610 */
        td_u32  bit1_awb_stat1                 : 1;   /* [8] */
        td_u32  bit1_awb_stat2                 : 1;   /* [9] */
        td_u32  bit2_reserved0                 : 2;   /* [10:11] */
        td_u32  bit1_fe_af_stat                : 1;   /* [12] not support for Hi3516CV610 */
        td_u32  bit1_be_af_stat                : 1;   /* [13] */
        td_u32  bit2_reserved1                 : 2;   /* [14:15] */
        td_u32  bit1_dehaze                    : 1;   /* [16] */
        td_u32  bit1_mg_stat                   : 1;   /* [17] not support for Hi3516CV610 */
...
typedef struct {
    td_u16 grid_y_pos[OT_ISP_BE_AE_ZONE_ROW + 1];   /* R */
    td_u16 grid_x_pos[OT_ISP_BE_AE_ZONE_COLUMN + 1]; /* R */
    td_u8  status;                        /* R;0:not update, 1: update,others:reserved */
} ot_isp_be_ae_grid_info;
...
typedef struct {
    ...
    td_u16 fe_global_avg[OT_ISP_WDR_MAX_FRAME_NUM][OT_ISP_BAYER_CHN_NUM]; /* R; Range: [0x0, 0xFFFF]; Format:16.0;
                                                         Global average value of FE, not support for Hi3516CV610 */
    td_u16 fe_zone_avg[OT_ISP_WDR_MAX_FRAME_NUM][OT_ISP_AE_ZONE_ROW][OT_ISP_AE_ZONE_COLUMN][OT_ISP_BAYER_CHN_NUM]; /* R;
                          Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of FE, not support for Hi3516CV610 */
    ...
    td_u16 be_zone_avg[OT_ISP_BE_AE_ZONE_ROW][OT_ISP_BE_AE_ZONE_COLUMN][OT_ISP_BAYER_CHN_NUM]; /* R; Range:
    [0x0, 0xFFFF]; Format:16.0; Zone average value of BE */
    ot_isp_ae_grid_info fe_grid_info; /* not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16 be_zone_avg[OT_ISP_MAX_STITCH_NUM][OT_ISP_BE_AE_ZONE_ROW][OT_ISP_BE_AE_ZONE_COLUMN][OT_ISP_BAYER_CHN_NUM];
     /* R; Range: [0x0, 0xFFFF]; Format:16.0; Zone average value of BE */
    td_u64 pts;
} ot_isp_ae_stitch_stats; /* Not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16 zone_col;           /* RW; Range: [0x1, 0x20]; Horizontal Blocks,
                                  limited range:[max(blk_num, ceil(width / 1024)), min(32, image_width / 20)] */
    ...
    td_u16 black_level;        /* RW; Range: [0x0, white_level];limited range: [0x0, white_level],
    ...
    td_u16 cb_min;             /* RW; Range: [0x0, cb_max];
                                  limited range: [0x0, cb_max]Minimum value of B/G for white region */
    td_u16 cr_max;             /* RW; Range: [0x0, 0xFFF];Maximum value of R/G for white region */
    td_u16 cr_min;             /* RW; Range: [0x0, cr_max];
                                  limited range: [0x0, cr_max],Minimum value of R/G for white region */
...
typedef struct {
    ...
    td_u64 pts;
} ot_isp_wb_stitch_stats; /* Not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_u16  hl_cnt;        /* R; Range: Hi3519DV500 = [0x0, 0xFFFF] | Hi3516CV610 = [0x0, 0x7FFF]; hl_cnt Statistics */
} ot_isp_focus_zone;
...
typedef struct {
    td_u8 motion_ratio; /* R; Range: [0,100]; detect motion ratio */
    td_u64 pts;
} ot_isp_motion_stats; /* Not support for Hi3519DV500 */

typedef struct {
    td_bool motion_stats_en; /* RW; Range: [0,1];  Format:1.0; motion stats enable */
    td_u8 motion_thr; /* RW; Range: [0x0, 0x10]; motion_statistics range */
} ot_isp_motion_stats_cfg; /* Not support for Hi3519DV500 */
...
typedef struct {
    ...
    ot_isp_motion_stats_cfg motion_cfg; /* Not support for Hi3519DV500 */
} ot_isp_stats_cfg;
...
typedef struct {
    ...
    td_phys_addr_t  phys_addr;     /* RW; physics address of debug info */
...
typedef struct {
    ...
    ot_isp_sns_commbus  com_bus_multi[OT_ISP_PIPE_SENSOR_MAX_NUM];
    td_u8   dev_addr_multi[OT_ISP_PIPE_SENSOR_MAX_NUM];
    td_u32  sns_multi_num; /* RW;default 0 */
    union {
    ...
    struct {
        ...
        td_u32 slave_hs_time;
        td_u32 slave_vs_cycle;
        td_u32 slave_hs_cycle;
        td_u32 slave_hs_dly_cyc;
    } slv_sync;
...
typedef struct {
    ...
    td_u32  max_iris_fno_target_linear;  /* RW; Range:[1, 1024]; Format:16.0;
                                            ...
                                            only used when fno_ex_valid is true, it's related to the specific iris */
...
typedef struct {
    ...
    td_u32 min;  /* RW;Range:[0,0xFFFFFFFF];Format:32.0;limited Range:[0,max],Minimum value */
} ot_isp_ae_range;
...
typedef struct {
    ...
    td_u8   luma_diff; /* RW; Range:[0, 100]; Format:8.0; if subflicker mode enable, current luma is less than AE
                          compensation plus luma_diff, AE will keep min antiflicker shutter time
                          (for example: 1/100s or 1/120s) to avoid flicker. while current luma is larger than AE
                          compensation plus the luma_diff, AE will reduce shutter time to avoid over-exposure and
...
typedef struct {
    ...
    td_u32 exp_ratio[OT_ISP_EXP_RATIO_NUM]; /* RW; Range:Hi3519dv500 = [0x40, 0x4000]; Hi3516cv610 = [0x40, 0x7FF];
                                        Format:26.6; 0x40 means 1 times.
                                        When exp_ratio_type is OT_OP_MODE_AUTO, exp_ratio is invalid.
                                        When exp_ratio_type is OT_OP_MODE_MANUAL, exp_ratio is quotient of
                                        long exposure time / short exposure time. */
    td_u32 exp_ratio_max;           /* RW; Range:Hi3519dv500 = [0x40, 0x4000]; Hi3516cv610 = [0x40, 0x7FF];
                                       Format:26.6; 0x40 means 1 times.
    ...
    td_u32 exp_ratio_min;          /* RW; Range:Hi3519dv500 = [0x40, 0x4000]; Hi3516cv610 = [0x40, 0x7FF];
                                      Format:26.6; limited Range:[0x40, exp_ratio_max], 0x40 means 1 times.
...
typedef struct {
    ot_op_mode  exp_hdr_lv_type;   /* RW; Range:[0, 1]; Format:1.0;
                                         OT_OP_MODE_AUTO: The exp_hdr_lv used in ISP is generated by firmware;
                                         OT_OP_MODE_MANUAL: The exp_hdr_lv used in ISP is set by exp_hdr_lv */
    ...
    td_u32 exp_hdr_lv_max;         /* RW; Range:[0x40, 0x400]; Format:26.6; 0x40 means 1 times.
                                      ...
                                      exp_hdr_lv generated by firmware.
...
typedef struct {
    ...
    ot_op_mode   smart_exp_type;  /* RW; Range:[0, 1]; Format:1.0;
                                       OT_OP_MODE_AUTO: The exp_coef used in ISP is  generated by firmware;
                                       OT_OP_MODE_MANUAL: The exp_coef used in ISP is set by exp_coef */
    td_u16  exp_coef;          /* RW; Range:[0x0, 0xFFFF]; Format:6.10; 0x400 means 1 times.
                                  When smart_exp_type is OT_OP_MODE_AUTO, exp_coef is invalid.
                                  When smart_exp_type is OT_OP_MODE_MANUAL, exp_coef is the quotient of exposure. */
    ...
    td_u16  exp_coef_max;      /* RW; Range:[0x0, 0xFFFF]; Format:6.10; 0x400 means 1 times.
                                  When smart_exp_type is OT_OP_MODE_AUTO, exp_coef_max is max(upper limit) of exp_coef
                                  generated by firmware.
                                  When smart_exp_type is OT_OP_MODE_MANUAL, exp_coef_max is invalid. */
    td_u16  exp_coef_min;      /* RW; Range:[0x0, 0xFFFF]; Format:6.10; 0x400 means 1 times.
                                  When smart_exp_type is OT_OP_MODE_AUTO, exp_coef_min is min(lower limit) of exp_coef
                                  generated by firmware.
                                  When smart_exp_type is OT_OP_MODE_MANUAL, exp_coef_min is invalid. */
...
typedef struct {
    ...
    td_s32 curve_para[OT_ISP_AWB_CURVE_PARA_NUM]; /* RW; Format:32.0;Calibration Information,
                                              limited Range:curve_para[3] != 0, curve_para[4]==128 */
...
typedef struct {
    td_u8 hue_shift[OT_ISP_COLOR_SECTOR_NUM]; /* RW; Range: [0x0, 0x28]; Format:8.0;CCM */
    td_u8 sat_shift[OT_ISP_COLOR_SECTOR_NUM]; /* RW; Range: [0x0, 0x28]; Format:8.0;CCM */
} ot_isp_color_sector_manual; /* Not support for Hi3519DV500 */

typedef struct {
    td_u8 hue_shift[OT_ISP_COLOR_SECTOR_NUM]; /* RW; Range: [0x0, 0x28]; Format:8.0;CCM */
    td_u8 sat_shift[OT_ISP_COLOR_SECTOR_NUM]; /* RW; Range: [0x0, 0x28]; Format:8.0;CCM */
} ot_isp_color_sector_param; /* Not support for Hi3519DV500 */

typedef struct {
    ot_isp_color_sector_param color_tab[OT_ISP_CCM_MATRIX_NUM];
} ot_isp_color_sector_auto; /* Not support for Hi3519DV500 */

typedef struct {
    td_bool enable;            /* RW; Range: [0, 1];  Format:1.0; If enabled, sector on */
    ot_isp_color_sector_manual manual_attr;
    ot_isp_color_sector_auto   auto_attr;
} ot_isp_color_sector_attr; /* Not support for Hi3519DV500 */
...
typedef struct {
    ...
    td_u32  rg_min;           /* RW, Range: [0x0, rg_max]. Minimum value of R/G in IR scene, 4.8-bit fix-point. */
    td_u32  bg_max;           /* RW, Range: [0x0, 0xFFF].    Maximum value of B/G in IR scene, 4.8-bit fix-point. */
    td_u32  bg_min;           /* RW, Range: [0x0, bg_max]. Minimum value of B/G in IR scene, 4.8-bit fix-point. */
