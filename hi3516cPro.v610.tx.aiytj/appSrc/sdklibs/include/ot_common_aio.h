...
typedef struct {
    td_s8  gain_db[OT_VQE_EQ_BAND_NUM];   /* EQ band, include 100, 200, 250, 350, 500, 800, 1.2k, 2.5k, 4k, 8k in turn,
                                             range:TalkVQE/AoVQE[-100, 10], RecordVQE[-50, 20] */
    td_s32 reserved;
} ot_audio_eq_cfg;
...
typedef struct {
    ...
    td_s32 freq_move;   /* frequency move, default:5, range:[0, 30] */
...
typedef struct {
    ...
    td_s16 min_gain_limit;            /* maximum allowable noise rejection, default:1036, range:[1, 32767] */
    td_s16 snr_prior_limit;           /* minimum prior snr ratio, default:33, range:[1, 32767] */
    td_s16 ht_threshold;              /* voice decision threshold, default:130, range:[0, 1000] */
    td_s16 hs_threshold;              /* harmonic detection threshold, default:100, range:[100, 1100] */
    td_s16 prior_snr;                 /* prior snr, default:10, range:[0, 20] */
    ...
    td_s16 cep_alpha;                 /* noise smooth rate, default:100, range:[0, 100] */
    ...
    td_s8 gain_sm_mode;               /* noise smooth mode, default:1, range:[0, 1] */
    td_s8 gain_sm_alpha1;             /* voice noise reduction smooth factor, default:30, range:[0, 100] */
    td_s8 gain_sm_alpha2;             /* non-voice noise reduction smooth factor, default:70, range:[0, 100] */
    td_s8 gain_sm_alpha3;             /* noise reduction below 300Hz smooth factor, default:80, range:[0, 100] */

    td_s16 reserved[1]; /* 1: reserved */
...
typedef struct {
    ...
    td_u16 echo_boost1; /* Non-linear echo suppression coefficient for 0-subband1, default:1, range:[1, 100] */
    td_u16 echo_boost2; /* Non-linear echo suppression coefficient for subband1-subband2, default:4, range:[1, 100] */
    td_u16 echo_boost3; /* Non-linear echo suppression coefficient for subband2-subband3, default:12, range:[1, 100] */
    td_u16 echo_boost4; /* Non-linear echo suppression coefficient for subband3-subband4, default:4, range:[1, 100] */
    td_u16 echo_boost5; /* Non-linear echo suppression coefficient for subband4-8000Hz, default:1, range:[1, 100] */
    td_u16 reserved[1]; /* 1: reserved */
} ot_ai_talk_v2_aec_cfg;

typedef struct {
    td_bool usr_mode; /* mode 0: auto, mode 1: manual. */

    td_s8 min_gain_limit; /* maximum allowable noise rejection, default:8, range:[1, 8] */
    td_s8 reserved[4]; /* 6: reserved */
...
typedef struct {
    ...
    td_s8 comfort_intensity; /* comfort intensity, default:1, range:[1, 10] */
