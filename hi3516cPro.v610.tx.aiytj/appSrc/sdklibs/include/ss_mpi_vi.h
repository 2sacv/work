...
td_s32 ss_mpi_vi_set_pipe_buf_wrap_attr(ot_vi_pipe vi_pipe, const ot_vi_pipe_buf_wrap_attr *wrap_attr);
td_s32 ss_mpi_vi_get_pipe_buf_wrap_attr(ot_vi_pipe vi_pipe, ot_vi_pipe_buf_wrap_attr *wrap_attr);
...
td_s32 ss_mpi_vi_distribute_one_frame(ot_vi_grp distribute_grp, ot_vi_pipe vi_pipe);
td_s32 ss_mpi_vi_set_pipe_switch_sensor_attr(ot_vi_pipe vi_pipe, const ot_vi_switch_sensor_attr *switch_sensor_attr);
td_s32 ss_mpi_vi_get_pipe_switch_sensor_attr(ot_vi_pipe vi_pipe, ot_vi_switch_sensor_attr *switch_sensor_attr);
