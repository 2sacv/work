...
typedef struct {
    td_bool             distribute_en;
    td_bool             grp_share_vs;
    td_u32              slave_mode_time;
    ot_vi_pipe          pipe_id[OT_VI_MAX_DISTRIBUTE_PIPE_NUM];
} vi_distribute_attr;
#endif
...
typedef struct {
    td_bool             bnr_en;
    td_bool             bnr_ctrl_en;
    td_bool             bnr_load_ref_en;
    ot_isp_bnr_ref_mode bnr_ref_mode;
} vi_isp_bnr_cfg;
...
#ifdef CONFIG_OT_VI_DISTRIBUTE_GRP
typedef td_s32  fn_vi_get_pipe_distribute_attr(ot_vi_pipe vi_pipe, vi_distribute_attr *distribute_attr);
typedef td_s32  fn_vi_pipe_set_distribute_grp_stop_send(ot_vi_pipe vi_pipe);
typedef td_s32  fn_vi_pipe_set_distribute_grp_restore_send(ot_vi_pipe vi_pipe);
typedef ot_vi_pipe  fn_vi_get_pipe_distribute_working_id(ot_vi_pipe vi_pipe, td_bool ignore_stop_flag);
typedef td_s32  fn_vi_get_pipe_switch_sensor_en(ot_vi_pipe vi_pipe, td_bool *switch_sensor_en);
#endif
...
typedef td_s32  fn_vi_set_pipe_bnr_cfg(ot_vi_pipe vi_pipe, vi_isp_bnr_cfg *isp_bnr_cfg);
typedef td_s32  fn_vi_set_pipe_disable_bnr_wmot(ot_vi_pipe vi_pipe);
#ifdef CONFIG_OT_SYS_VI_WRAP_SUPPORT
typedef td_s32  fn_vi_get_pipe_wrap_sns_slave_en(ot_vi_pipe vi_pipe, td_bool *wrap_en);
typedef td_s32  fn_vi_set_pipe_wrap_slave_discard_flag(ot_vi_pipe vi_pipe);
#endif
#ifdef IQ_DEBUG
...
typedef td_s32 fn_vi_clear_kol_int_num(td_void);
#endif
...
typedef struct {
...
#ifdef CONFIG_OT_SYS_3DNR_POS_SET_SUPPORT
...
#ifdef CONFIG_OT_VI_DISTRIBUTE_GRP
    fn_vi_get_pipe_distribute_attr    *pfn_vi_get_pipe_distribute_attr;
    fn_vi_pipe_set_distribute_grp_stop_send       *pfn_vi_pipe_set_distribute_grp_stop_send;
    fn_vi_pipe_set_distribute_grp_restore_send    *pfn_vi_pipe_set_distribute_grp_restore_send;
    fn_vi_get_pipe_distribute_working_id    *pfn_vi_get_pipe_distribute_working_id;
    fn_vi_get_pipe_switch_sensor_en   *pfn_vi_get_pipe_switch_sensor_en;
#endif
    ...
    fn_vi_set_pipe_bnr_cfg           *pfn_vi_set_pipe_bnr_cfg;
    fn_vi_set_pipe_disable_bnr_wmot   *pfn_vi_set_pipe_disable_bnr_wmot;
#ifdef CONFIG_OT_SYS_VI_WRAP_SUPPORT
    fn_vi_get_pipe_wrap_sns_slave_en           *pfn_vi_get_pipe_wrap_sns_slave_en;
    fn_vi_set_pipe_wrap_slave_discard_flag     *pfn_vi_set_pipe_wrap_slave_discard_flag;
#endif
#ifdef IQ_DEBUG
...
#ifdef CONFIG_OT_SYS_KOL_SUPPORT
    fn_vi_clear_kol_int_num           *pfn_vi_clear_kol_int_num;
#endif
} vi_export_func;
...
#ifdef CONFIG_OT_VI_DISTRIBUTE_GRP
#define ckfn_vi_get_distribute_attr() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_distribute_attr != TD_NULL)
#define call_vi_get_distribute_attr(vi_pipe, distribute_attr) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_distribute_attr(vi_pipe, distribute_attr)

#define ckfn_vi_get_distribute_working_id() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_distribute_working_id != TD_NULL)
#define call_vi_get_distribute_working_id(vi_pipe, ignore_stop_flag) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_distribute_working_id(vi_pipe, ignore_stop_flag)

#define ckfn_vi_set_distribute_stop_send() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_pipe_set_distribute_grp_stop_send != TD_NULL)
#define call_vi_set_distribute_stop_send(vi_pipe) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_pipe_set_distribute_grp_stop_send(vi_pipe)
#define ckfn_vi_set_distribute_restore_send() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_pipe_set_distribute_grp_restore_send != TD_NULL)
#define call_vi_set_distribute_restore_send(vi_pipe) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_pipe_set_distribute_grp_restore_send(vi_pipe)
#define ckfn_vi_get_pipe_switch_sensor_en() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_switch_sensor_en != TD_NULL)
#define call_vi_get_pipe_switch_sensor_en(vi_pipe, switch_sensor_en) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_switch_sensor_en(vi_pipe, switch_sensor_en)
#endif
...
#ifdef CONFIG_OT_SYS_VI_WRAP_SUPPORT
#define ckfn_vi_get_pipe_wrap_sns_slave_en() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_wrap_sns_slave_en != TD_NULL)
#define call_vi_get_pipe_wrap_sns_slave_en(vi_pipe, wrap_sns_slave_en) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_get_pipe_wrap_sns_slave_en(vi_pipe, wrap_sns_slave_en)
 
#define ckfn_vi_set_pipe_wrap_slave_discard_flag() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_wrap_slave_discard_flag != TD_NULL)
#define call_vi_set_pipe_wrap_slave_discard_flag(vi_pipe) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_wrap_slave_discard_flag(vi_pipe)
#endif
...
#define ckfn_vi_set_pipe_bnr_cfg() \
    (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_bnr_cfg != TD_NULL)
#define call_vi_set_pipe_bnr_cfg(vi_pipe, isp_bnr_cfg) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_bnr_cfg(vi_pipe, isp_bnr_cfg)
...
#ifdef CONFIG_OT_SYS_KOL_SUPPORT
#define ckfn_vi_clear_kol_int_num() (func_entry(vi_export_func, OT_ID_VI)->pfn_vi_clear_kol_int_num != TD_NULL)
#define call_vi_clear_kol_int_num() func_entry(vi_export_func, OT_ID_VI)->pfn_vi_clear_kol_int_num()
#endif
...
typedef struct {
    ...
    union {
        ot_isp_fpn_calibrate_attr calibrate_attr; /* AUTO:vi_fpn_work_mode: FPN_MODE_CALIBRATE */
        ot_isp_fpn_attr correction_attr; /* AUTO:vi_fpn_work_mode: FPN_MODE_CORRECTION */
    };
} vi_fpn_attr;
...
td_s32 mpi_vi_set_slave_sync_time(ot_vi_dev vi_dev, td_u32 slave_mode_time);
td_s32 mpi_vi_set_motion_stats_cfg(ot_vi_pipe vi_pipe, const ot_isp_motion_stats_cfg *motion_stats_cfg);
td_s32 mpi_vi_get_motion_stats_cfg(ot_vi_pipe vi_pipe, ot_isp_motion_stats_cfg *motion_stats_cfg);
td_s32 mpi_vi_get_motion_stats(ot_vi_pipe vi_pipe, ot_isp_motion_stats *motion_stats);
