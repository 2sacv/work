...
typedef struct {
    td_u32   exp_ratio[OT_ISP_EXP_RATIO_NUM]; /* RW; Range:[0x0, 0x7FF]; */
...
typedef union {
    ...
    struct {
        ...
        td_u64  bit1_pregamma         : 1;   /* [2] Not support for Hi3516CV610 */
        ...
        td_u64  bit1_clut             : 1;   /* [13] Not support for Hi3516CV610 */
        td_u64  bit1_wdr              : 1;   /* [14] */
        td_u64  bit1_dehaze           : 1;   /* [15] */
        td_u64  bit1_cac              : 1;   /* [16] */
        td_u64  bit1_acs              : 1;   /* [17] */
        td_u64  bit1_bshp             : 1;   /* [18] Not support for Hi3516CV610 */
        td_u64  bit1_lblc             : 1;   /* [19] Not support for Hi3516CV610 */
...
typedef struct {
    ...
    td_s32 (*pfn_cmos_get_standby_cfg)(ot_vi_pipe vi_pipe, ot_isp_sns_regs_info *sns_regs_info);
    td_s32 (*pfn_cmos_get_restart_cfg)(ot_vi_pipe vi_pipe, ot_isp_sns_regs_info *sns_regs_info);
    td_s32 (*pfn_cmos_get_wrap_first_frame)(ot_vi_pipe vi_pipe, td_bool *first_frame);
} ot_isp_sns_exp_func;
