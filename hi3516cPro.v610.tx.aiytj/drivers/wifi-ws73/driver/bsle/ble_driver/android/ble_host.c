...
static uint8_t bt_vendor_event_close[BT_VENDOR_EVENT_LEN] = { 0x04, 0xff, 0x01, 0xc8 };

void set_ble_state(oal_uint8 ble_state)
{
...
int send_bt_close_msg(void)
{
    return bt_dev_rx(bt_vendor_event_close, BT_VENDOR_EVENT_LEN);
}
