...
{
#ifndef OT_FPGA
    void *iocfg_base = sys_config_get_reg_iocfg3(); //0x11130000
...
static void jco_pin_mux(void)
{
    void *iocfg_base = sys_config_get_reg_iocfg();    //0x10260000
    void *iocfg2_base = sys_config_get_reg_iocfg2();  //0x17940000
    void *iocfg3_base = sys_config_get_reg_iocfg3();  //0x11130000

    //ptz pin mux
    sys_writel(iocfg3_base, 0x0054, 0x1005);  //18 GPIO7_4 MOTOR_CLK
    sys_writel(iocfg3_base, 0x0050, 0x1005);  //19 GPIO7_5 MOTOR_DATA
    sys_writel(iocfg3_base, 0x0044, 0x1202);  //22 GPIO1_3 WPS_SYS
    sys_writel(iocfg3_base, 0x0040, 0x1200);  //23 GPIO1_2 MOTOR_EN
    sys_writel(iocfg3_base, 0x0048, 0x1100);  //21 GPIO1_1 VIDEO_CALL_BUTTON
    sys_writel(iocfg3_base, 0x003c, 0x1200);  //24 GPIO1_0 WHITE_LED_EN
    sys_writel(iocfg3_base, 0x0038, 0x1100);  //25 GPIO7_7 TOUCH_OUT
    sys_writel(iocfg3_base, 0x0030, 0x1202);  //27 GPIO0_6 IR_LED_EN

    sys_writel(iocfg2_base, 0x0094, 0x1200);  //45 GPIO7_1 WiFi/4G_EN
    sys_writel(iocfg2_base, 0x0090, 0x1100);  //46 GPIO7_0 SPK_EN

    //ETH_LINK_ACT
    sys_writel(iocfg3_base, 0x0034, 0x1201);  //ETH_LINK_ACT_LED
}
