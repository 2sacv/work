...
static const struct usb_device_id option_ids[] = {
	...
	//+add by chuangjing for JK815
	{ USB_DEVICE(0x21f5, 0x2012) },
	//+add by yuga for clm920
	{ USB_DEVICE(0x1286, 0x4E3C),
		.driver_info = RSVD(0) | RSVD(1) },
	//+add by quectel EC200S/EC600N/EC600S
	...
	{ USB_DEVICE(TELIT_VENDOR_ID, 0x9201),				/* Telit LE910R1 flashing device */
	  .driver_info = NCTRL(0) | ZLP },
    { USB_DEVICE_AND_INTERFACE_INFO(0x1782, 0x4d10, 0xff, 0, 0)}, /*NT90*/
    { USB_DEVICE_AND_INTERFACE_INFO(0x1782, 0x4d11, 0xff, 0, 0)},
    { USB_DEVICE_AND_INTERFACE_INFO(0x2c7c, 0x0903, 0xff, 0, 0)}, /*EC800E*/	  
	...
	if (iface_desc->bInterfaceClass == USB_CLASS_MASS_STORAGE)
	 ...
	 //+add by yuga for clm920
       ...
       //         return -ENODEV;
        ...
        /*if (dev_desc->idVendor == cpu_to_le16(0x1782) &&
            dev_desc->idProduct == cpu_to_le16(0x4d10)) {
            if (iface_desc->bInterfaceNumber <= 1) {
                printk("NT90 222\n");
                return -ENODEV;
            }
        }*/
        if (dev_desc->idVendor == cpu_to_le16(0x1782) &&
            dev_desc->idProduct == cpu_to_le16(0x4d11)) {
            if (iface_desc->bInterfaceNumber <= 1) {
                return -ENODEV;
            }
        }
