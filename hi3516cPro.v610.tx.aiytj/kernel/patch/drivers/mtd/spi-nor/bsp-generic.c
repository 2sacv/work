...
static const struct flash_info general_parts[] = {
	...
	{ "gd25q32", 	INFO(0xc84016, 0, 64 * 1024,  64,
					SECT_4K | SPI_NOR_QUAD_READ) PARAMS(gd), CLK_MHZ_2X(120) },
	{ "gd25q64", 	INFO(0xc84017, 0, 32 * 1024, 256,
					SECT_4K | SPI_NOR_QUAD_READ) PARAMS(gd), CLK_MHZ_2X(120) },
	...
	{ "xm25qh128b", INFO(0x206018, 0, 64 * 1024,   256, SPI_NOR_QUAD_READ)
					PARAMS(xmc), CLK_MHZ_2X(104) .fixups = &xm25q128a_fixups},
	{ "xm25qh64c",  INFO(0x204017, 0, 32 * 1024,   256, SPI_NOR_QUAD_READ)
					PARAMS(xmc), CLK_MHZ_2X(104) },
	{ "xm25qh128c", INFO(0x204018, 0, 64 * 1024,   256, SPI_NOR_QUAD_READ)
					PARAMS(xmc), CLK_MHZ_2X(104) },
	/* zbit */
	{ "ZB25VQ64",   INFO(0x5e4017, 0, 32 * 1024, 256,
	                SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) PARAMS(zbit),CLK_MHZ_2X(120)},
	{ "ZB25VQ128",  INFO(0x5e4018, 0, 64 * 1024,   256,
	                SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) PARAMS(zbit),CLK_MHZ_2X(120)},
    /* esmt */
    { "VEN25QH128A",INFO(0x1C7018, 0, 64 * 1024,  256, SPI_NOR_QUAD_READ)     
                    PARAMS(eon), CLK_MHZ_2X(104) .fixups = &xm25q128a_fixups},
    { "VEN25QX128A",INFO(0x1C7118, 0, 64 * 1024, 256,
                    SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) PARAMS(esmt),CLK_MHZ_2X(104)},
};
